...
const users_validate_1 = require("../validation/users.validate");
const router = express_1.default.Router();
const usersRouter = (app) => __awaiter(void 0, void 0, void 0, function* () {
    router.post('/register', users_validate_1.userRegisterSchemaValidate, controller.register);
    router.post('/login', users_validate_1.userLoginSchemaValidate, controller.login);
